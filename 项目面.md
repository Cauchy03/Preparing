...
```
首先客户端会发送一个DNS请求给本地DNS服务器，本地DNS服务器收到请求后，检查缓存查找域名，如果缓存中没有就访问根域名服务器。根DNS收到请求，返回.com .cn的顶级域名服务器地址，然后继续向顶级域名服务器发请求，顶级域名服务器又返回次级域名服务器（权威域名服务器），最终得到对应的ip地址，本地DNS服务器缓存结果，返回给客户端
```
